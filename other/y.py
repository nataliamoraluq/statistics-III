...
grupos = data.groupby('Variable1')['VariableDependiente'].apply(list)  # Reemplaza 'Variable1' con el nombre de tu columna
...
for variable in ['Variable1', 'Variable2', 'Variable3']:
    slope, intercept, r_value, p_value, std_err = linregress(data[variable], data['VariableDependiente'])
